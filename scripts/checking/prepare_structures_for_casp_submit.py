...
# This script prepare structures of directory for submitting to CASP
...
# Example: prepare_structures_for_casp_submission.py /home/faccioli/Dropbox/CASP11/T0773/
