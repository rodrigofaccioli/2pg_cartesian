...
static char *traj_comp_xtc = NULL;
...
void init_gromacs_execution (){
	...
	traj_comp_xtc = Malloc(char, MAX_FILE_NAME);
	...
	strcpy(traj_comp_xtc, "traj_comp.xtc");	
	strcpy(xvg_1, "*.xvg_1*");
...
void clean_gromacs_simulation(const char *path_local_execute){
	...
	delete_file(path_local_execute, traj_comp_xtc);
